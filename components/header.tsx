            ...
            {fullSize? (
                <header className="flex justify-between items-center mx-8 pt-6 font-montserrat">
                    ...
                    <div className="flex space-x-12 sm:text-sm">
                        <Link href="/"><div className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'Home' ? 'text-green' : null}`}>Home</p></div></Link>
                        <div className="flex flex-col">
                            <Link href="/projects"><div onMouseEnter={() => {InterruptDissapear(); Show(["cocktailmaker", "vitalcities", "portfolio"])}} onMouseLeave={() => Dissapear(["cocktailmaker", "vitalcities", "portfolio"])} className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'Projects' || params.active === "Vitalcities" || params.active === "Portfolio" || params.active === "Cocktailmaker" ? 'text-green' : null}`}>Projects</p></div></Link>
                            <div id="cocktailmaker" onMouseEnter={() => InterruptDissapear()} onMouseLeave={() => Dissapear(["cocktailmaker", "vitalcities", "portfolio"])} className="pb-1 px-1 pr-3 rounded-sm border-b-[1px] border-l-[1px] border-black dark:border-white hidden transition-opacity ease-in text-opacity-0 absolute mt-7"><Link href="/cocktailmaker"><div className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'Cocktailmaker' ? 'text-green': null}`}>Cocktailmaker</p></div></Link></div>
                            <div id="vitalcities" onMouseEnter={() => InterruptDissapear()} onMouseLeave={() => Dissapear(["cocktailmaker", "vitalcities", "portfolio"])} className="pb-1 px-1 pr-3 rounded-sm border-b-[1px] border-l-[1px] border-black dark:border-white hidden transition-opacity ease-in text-opacity-0 absolute mt-14"><Link href="/vitalcitiesbeweegscan"><div className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'Vitalcities' ? 'text-green': null}`}>Vital Cities Beweegscan</p></div></Link></div>
                            <div id="portfolio" onMouseEnter={() => InterruptDissapear()} onMouseLeave={() => Dissapear(["cocktailmaker", "vitalcities", "portfolio"])} className="pb-1 px-1 pr-3 rounded-sm border-b-[1px] border-l-[1px] border-black dark:border-white hidden transition-opacity ease-in text-opacity-0 absolute mt-[84px]"><Link href="/portfolio"><div className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'Portfolio' ? 'text-green': null}`}>Portfolio</p></div></Link></div>
                        </div>
                        <Link href="/about"><div className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'About' ? 'text-green' : null}`}>About</p></div></Link>
                        ...
                        <div className="h-screen flex flex-col justify-between py-6">
                            <div>
                                ...
                                <section className="mt-4 mx-4 md:mt-8 md:mx-8 space-y-4">
                                    <Link href="/"><div className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'Home' ? 'text-green' : null}`}>Home</p></div></Link>
                                    <Link href="/projects"><div className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'Projects' ? 'text-green' : null}`}>Projects</p></div></Link>
                                    <Link href="/about"><div className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'About' ? 'text-green' : null}`}>About</p></div></Link>
                                    ...
                                    <Link href="/contact"><div className="text-base dark:text-white text-black cursor-pointer"><p className={`${params.active === 'Contact' ? 'text-green' : null}`}>Contact</p></div></Link>
                                </section>
                            </div>
                        </div>
                    </div>
