...
const Blockproject = ({dark, image, title, explanation, altImage} : {dark: boolean, image: any, title: string, explanation: string, altImage: string}) => {
    return(
        <section className="flex items-center md:grid md:grid-cols-3 space-x-4 mb-16">
            ...
            <div className="hidden 2xl:w-[500px] md:block md:col-start-3 md:col-end-4 relative w-30 h-30">
