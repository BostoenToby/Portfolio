    ...
    return(
        <div className={`${dark? 'dark' : null}`}>
          <div className="portrait:h-screen landscape:h-full landscape:pb-60 dark:bg-black bg-white">
              ...
              <main className="font-montserrat flex items-center justify-center space-x-20 mt-4 md:mt-16 h-[70vh] mx-8 flex-col lg:flex-row landscape:mt-60 landscape:lg:mt-20">
